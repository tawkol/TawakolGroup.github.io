...
$workers = new workers();
$InteriorDesign = $workers->InteriorDesign();
?>
...
<section class="workers">
    <header>
        <nav class="worker-nav">
            <ul>
                ...
                <li class="filter-active"><a href="./Interior-design.php">Interior design</a></li>
    ...
    <div class="worker-wrapper">
        <?php
        if ($InteriorDesign->rowCount() > 0) {
            while ($row = $InteriorDesign->fetch()) {
        ?>
